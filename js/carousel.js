...
//				callback && callback();
	 ...
	 * @return {[type]}         [description]
	 */
	this.palyVideo = function(currIndex,callback) {
		var dtd = $.Deferred();
		//索引从0开始
		var index = currIndex
		 ...
		 * @type {[type]}
		 */
		var $video = $('<video preload="auto"  class="bounceIn" style="width: 6rem;height: 7rem;left: 50%;margin-left: -3rem;top: -1.1rem;"></video>');
		$video.css({
			"position": "absolute",
			"z-index": "999"
		})
